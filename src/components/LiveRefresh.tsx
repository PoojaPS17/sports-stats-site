...
// a scoreboard tracks ESPN's feed (which the server reads with a 30-second cache)
// instead of waiting for the next visit. Pauses when the tab is hidden.
export function LiveRefresh({ active, seconds = 30 }: { active: boolean; seconds?: number }) {
